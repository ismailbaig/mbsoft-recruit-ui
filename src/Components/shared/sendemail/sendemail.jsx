        ...
        <div>
            <form ref={form} onSubmit={handleSubmit}>
                <div className="col-md-6 form-group mb-3 ">
                    ...
                    <input name="user_name" type="text" className="form-control " id="exampleInputName" value={formValues.user_name} onChange={handleChange} />
                </div>
                <div className="errorMessage"><p>{formErrors.user_name}</p></div>
                <div className="col-md-6 form-group mb-3">
                ...
                <div className="form-group mb-3">
                    <label htmlFor="user_email" style={{ float: 'left' }}>Email address</label>
                    <input name="user_email" className="form-control" id="user_email" value={formValues.user_email} onChange={handleChange} />
                </div>
                <div className="errorMessage"><p>{formErrors.user_email}</p></div>

                <div className="form-group mb-3">
                    <label htmlFor="exampleInputPhone" style={{ float: 'left' }}>Phone</label>
                    <input name="phoneNo" type="tel" className="form-control" id="exampleInputPhone" 
                    value={formValues.phoneNo} onChange={handleChange} />
                </div>
                ...
                <div className="form-group mb-3">
                    <label htmlFor="subjectFor" style={{ float: 'left' }}>Subject</label>
                    <input name="subject" type="tel" className="form-control" id="subjectId" value={formValues.subject} onChange={handleChange} />
                </div>
                <div className="errorMessage"><p>{formErrors.subject}</p></div>
                ...
                <div className="form-group mb-3 mt-3">
                    ...
                    value={formValues.message} onChange={handleChange}></textarea>
                </div>
